 ...
 */
final class Version20200813062607 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, material_id INT DEFAULT NULL, format_id INT DEFAULT NULL, picture_id INT DEFAULT NULL, pro_name VARCHAR(50) NOT NULL, pro_stock_ale INT NOT NULL, pro_unit_price INT NOT NULL, pro_unit_stock_phy INT NOT NULL, pro_unit_on_order INT NOT NULL, pro_discontinued INT NOT NULL, pro_note INT DEFAULT NULL, pro_lib VARCHAR(25) NOT NULL, pro_description VARCHAR(255) NOT NULL, INDEX IDX_D34A04ADE308AC6F (material_id), INDEX IDX_D34A04ADD629F605 (format_id), INDEX IDX_D34A04ADEE45BDBF (picture_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE suppliers (id INT AUTO_INCREMENT NOT NULL, picture_id INT DEFAULT NULL, suppli_company_name VARCHAR(255) NOT NULL, suppli_mail VARCHAR(255) NOT NULL, suppli_phone VARCHAR(50) NOT NULL, INDEX IDX_AC28B95CEE45BDBF (picture_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, role_id INT DEFAULT NULL, picture_id INT DEFAULT NULL, user_last_name VARCHAR(50) DEFAULT NULL, user_first_name VARCHAR(50) DEFAULT NULL, user_phone VARCHAR(25) NOT NULL, user_birthday DATE NOT NULL, user_gender VARCHAR(15) DEFAULT NULL, user_email VARCHAR(255) NOT NULL, user_password VARCHAR(255) NOT NULL, INDEX IDX_8D93D649D60322AC (role_id), INDEX IDX_8D93D649EE45BDBF (picture_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
